...
![Left: Firefox using roughly a process per tab - Right: Fission-enabled Firefox, which uses a process per site (i.e., a seperate one for each banner ad and social button).](/images/new-fission.png)

Left: Current Firefox generally grouping a tab in its own process. Right: Fission-enabled Firefox, separating each site in its own process.
...
![Inter-Process Communication building on top of JSActors and implemented as FooParent and FooChild](/images/jsactors.png)
...
![Code sample for a receiveMessage function in a JSActor](/images/promptparent-excerpt.png)
...
![Inter-Process Communication using MessageManager](/images/image6.png)
...
![Code sample for a receiveMessage function using the MessageManger API](/images/addonsmanager-receivemessage-code-sample.png)
...
![Enabling Browser debugging in Firefox Developer Tools](/images/image4.png) 
...
![Hitting a breakpoint in Firefox’s parent process using Firefox Developer Tools (left)](/images/alert-as-triggered-from-website-in-parent-devtools.png)
...
![Invoking JavaScript IPC from Firefox Developer Tools (bottom right) and observing the effects (top right)](/images/Bildschirmfoto-vom-2021-03-26-15-45-18.png) 
...
![Handling of untrusted message.data before and after fixing CVE-2019-11708.](/images/diff-prompt-coinbase-0day.png)
